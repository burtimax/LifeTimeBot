...
namespace LifeTimeBot.Db.AppDb.Migrations
{
    ...
    [Migration("20250128000249_AddUserTaskNotificationEntity")]
    partial class AddUserTaskNotificationEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LifeTimeBot.Db.AppDb.Entities.UserTaskEntity", b =>
                {
                    ...
                    b.Property<string>("Comment")
                        .HasColumnType("text")
                        .HasColumnName("comment")
                        .HasComment("Комментарий к задаче, подробности от пользователя");

                    b.Property<bool>("Confirmed")
                        .HasColumnType("boolean")
                        .HasColumnName("confirmed")
                        .HasComment("Подтверждена задача пользователем? Правильно ли сформирована.");
                    ...
                    b.Property<string>("Emoji")
                        .HasColumnType("text")
                        .HasColumnName("emoji")
                        .HasComment("Emoji задачи");

                    b.Property<DateTime?>("EndTime")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("end_time")
                        .HasComment("Время окончания задачи");
                    ...
                    b.Property<DateTime?>("StartTime")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("start_time")
                        .HasComment("Время начала задачи");
