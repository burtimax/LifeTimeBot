...
```bash
dotnet ef migrations add AddTypesToActivities -o Db/AppDb/Migrations --context AppDbContext --project LifeTimeBot/LifeTimeBot --startup-project LifeTimeBot/LifeTimeBot
